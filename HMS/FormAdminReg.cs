...
namespace HMS
{
    public partial class FormAdminReg : Form
    {
        ...
        {
            string sql = "INSERT INTO admin (id,first_name,last_name,date_of_appointment,address,contact_no,password) VALUES('" + txtRegNo.Text + "','" + txtFirstName.Text + "','" + txtLastName.Text + "','" + dtpAppointed.Value.Date.ToString("yyyy-MM-dd") + "','" + txtAddress.Text + "','" + txtContactNo.Text + "','"+txtPassword.Text+"')";
        ...
        public void clearDat()
        {
            ...
            txtAddress.Text = "";
            txtPassword.Text = "";
            dtpAppointed.ResetText();
        }

        private void FormAdminReg_Load(object sender, EventArgs e)
        {
            try
            {
